...
extern temp_IPC_MessageQueue_t MQ_CPU1_CM;
...
__interrupt void IPC_CM_ISR1(){
    ...
    bool status;
    do{
        status = temp_IPC_readMessageFromQueue(IPC_CPU1_L_CM_R, &MQ_CPU1_CM, IPC_ADDR_CORRECTION_DISABLE, &Message_received , IPC_NONBLOCKING_CALL);
